...
Variables (all BOOLEAN):
    ...
    ExportDemandHigh    True  = weekly soybean export inspections (metric tons) exceed the
...
def make_demand_dominant_candidate(module_id: str = "soybean-v1") -> OntologyCandidate:
    """
    D*: YieldForecastDown → SoyPriceUp ← ExportDemandHigh

    Export demand and yield signals jointly drive soybean price.
    ...
    return OntologyCandidate(
        ...
        edges=[
            ...
            _edge("ExportDemandHigh",  "SoyPriceUp", prior=0.70),
        ],
