...
Running standalone
------------------
    python -m src.domains.soybean_v1.scheduler

Programmatic usage
------------------
    from src.domains.soybean_v1.scheduler import IngestionScheduler
    scheduler = IngestionScheduler(engine, pipeline, run_hour_utc=9)
...
class IngestionScheduler:
    ...
    async def run_forever(self) -> None:
        ...
        """
        logger.info(
            "SoybeanIngestionScheduler starting. run_hour_utc=%d, backfill_days=%d",
