"""
USDANASSClient — fetches soybean planting, condition, and yield data from the
...
class USDANASSClient:
    """
    Asynchronous client for the USDA NASS Quick Stats API (soybeans).
    ...
    async def fetch_snapshot(self, target_date: date) -> SoybeanNASSSnapshot:
        """
        Fetch all three series concurrently and return a SoybeanNASSSnapshot.
    ...
    def build_snapshot(
        ...
        """
        Map raw NASS API rows to a SoybeanNASSSnapshot.  Static and synchronous
